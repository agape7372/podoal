...
export const WINERY_TIERS: WineryTier[] = [
  { level: 1, minGrapes: 0, name: '포도알 새싹', icon: '\u{1F331}', color: 'from-green-200 to-green-100' },
  { level: 2, minGrapes: 30, name: '포도 수확생', icon: '\u{1F347}', color: 'from-grape-200 to-grape-100' },
  { level: 3, minGrapes: 100, name: '주스 메이커', icon: '\u{1F9C3}', color: 'from-orange-200 to-yellow-100' },
  { level: 4, minGrapes: 300, name: '포도주 견습생', icon: '\u{1F377}', color: 'from-red-300 to-rose-200' },
  { level: 5, minGrapes: 500, name: '소믈리에', icon: '\u{1F942}', color: 'from-amber-300 to-yellow-200' },
  { level: 6, minGrapes: 1000, name: '와이너리 오너', icon: '\u{1F3F0}', color: 'from-purple-400 to-grape-300' },
  { level: 7, minGrapes: 2000, name: '포도 마스터', icon: '\u{1F451}', color: 'from-yellow-400 to-amber-300' },
];
